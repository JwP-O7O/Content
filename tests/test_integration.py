...
class TestSystemIntegration:
    ...
    async def test_complete_content_pipeline(self):
        ...
        with patch('src.api_integrations.exchange_api.ExchangeAPI.get_price_data', AsyncMock(return_value={'price': 50000})):
            with patch('src.api_integrations.twitter_api.TwitterAPI.post_tweet', AsyncMock(return_value={'id': '123'})):
    ...
    async def test_agent_communication(self):
        ...
        # Mock external calls
        with patch('src.api_integrations.exchange_api.ExchangeAPI.get_price_data', AsyncMock(return_value={})):
            with patch('src.api_integrations.news_api.NewsAPI.fetch_crypto_news', AsyncMock(return_value=[])):
    ...
    async def test_error_propagation(self):
        ...
        with patch('src.agents.market_scanner_agent.MarketScannerAgent.execute', side_effect=Exception("Test error")):
